        ...
        <div class="row">
          ...
          <div class="col-md-5 ml-auto">
            <div class="p-4 border mb-3">
              ...
              <p class="mb-0">Uttn@uttn.edu.mx</p>
            </div>
            <div class="p-4 border mb-3">
              <span class="d-block text-primary h6 text-uppercase">Phone</span>
              <p class="mb-0">5666-66-5565 </p>
            </div>
            <div class="p-4 border mb-3">
              <span class="d-block text-primary h6 text-uppercase">Place</span>
              <p class="mb-0">203 Fake St. Mountain View, REYNOSA, Tamaulipas, MX</p>
            </div>
