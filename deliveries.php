...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Deliveries</strong></div>
        </div>
      </div>
    </div>  
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-5">
            ...
            <div class="site-section-heading pt-3 mb-4">
              <h2 class="text-black">Deliveries</h2>
            </div>
            
            <p>Loading, transporting, and delivering items to clients or businesses in a safe, timely manner.</p>
            <p>Reviewing orders before and after delivery to ensure that orders are complete, the charges are correct, and the customer is satisfied.</p>
            <p>Assisting with loading and unloading items from vehicles.</p>
  ...
  <script async src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCCZxkwmz01eo5quFruFWeEyOxB3-u-B_8&libraries=geometry&callback=initMap" defer></script>

  <script src="apiss/geolocation.js"></script>
